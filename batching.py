...
def replace_key(n_keys, last_idx, arity, new_facts_indexes, new_facts_values, whole_train_facts, num_negative_samples):
    """
...
def Batch_Loader(train_i_indexes, train_i_values, n_values, n_keys, key_val, batch_size, arity, whole_train_facts, num_negative_samples):
    ...
    if val_key < 0.5:
        ...
        replace_key(n_keys, last_idx, arity, new_facts_indexes, new_facts_values, whole_train_facts, num_negative_samples)
